...
This example describes a system containing two **AND** nodes, A and B, with a
...
individual mechanisms. This goes against the idea that **AB** should exist
...
which makes the least difference to the cause repertoire. The irreducible cause
...
The labels ``(n0, n1, n2, n3, n4)`` correspond to nodes \(A, B, C, D, E\)
respectively. Thus the MIP is (AB | DE) X ([] | C), where [] denotes the empty
mechanism.
