...
class MiceCache(DictCache):
    ...
    Kwargs:
        parent_cache (MiceCache): The cache generated by the uncut
            ...
            unaffected by the cut are reused in this cache.
    """
    def __init__(self, subsystem, parent_cache=None):
        super(MiceCache, self).__init__()
        self.subsystem = subsystem

        # TODO: test and validate that parent_cache.subsystem.is_not_cut
        # And that subsystem is a just a cut version of parent_cache.subsys?
