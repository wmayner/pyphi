...
class RepertoireIrreducibilityAnalysis(
    ...
    _partition_margin: PyPhiFloat | None
    ...
    def __init__(
        ...
        self._partition_margin = (
            None if partition_margin is None else PyPhiFloat(partition_margin)
        )
    ...
    @property
    def partition_margin(self) -> PyPhiFloat | None:
    ...
    def partition_margin(self, value: float | None) -> None:
        self._partition_margin = None if value is None else PyPhiFloat(value)
