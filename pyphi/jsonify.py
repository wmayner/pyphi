...
def _loadable_models():
    ...
    classes = [
        ...
        pyphi.models.partitions.GeneralKCut,  # pyright: ignore[reportAttributeAccessIssue]
        pyphi.models.partitions.GeneralSetPartition,  # pyright: ignore[reportAttributeAccessIssue]
