...
class AnalyticalRelations(Relations):
    ...
    # No __len__: analytical relations hold no relation objects (iteration
    # raises), and the closed-form count (~2^(2^n)) exceeds sys.maxsize on
    # large systems, so a length would work at small sizes and raise at
    # production sizes. The count is num_relations().
