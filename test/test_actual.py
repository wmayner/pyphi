...
class TestActualCausationIIT30:
    ...
    @pytest.mark.skip(
        reason=(
            ...
            "picked (1,2) by iteration order; post-82b778ca picks (0,2) via "
            "partition.lex_key(), at which there are 0 true events. The "
            "downstream regression target — true_events output shape on a "
            "known irreducible complex — is covered by "
