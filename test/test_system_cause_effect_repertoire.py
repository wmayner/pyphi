...
scenarios = [
    ...
    (
        ...
        System(
            ...
            full,
            cut=DirectedBipartition(Direction.EFFECT, (2,), (0, 1)),
        ),
        [0],
        [1],
    ...
    (
        ...
        System(
            ...
            standard_system.state,
            (1, 2),
            cut=DirectedBipartition(Direction.EFFECT, (1,), (2,)),
        ),
        [2],
        [1, 2],
    ...
    (
        ...
        System(
            ...
            standard_system.state,
            (0, 2),
            cut=DirectedBipartition(Direction.EFFECT, (0,), (2,)),
        ),
        [2],
        [0],
        np.array([0.5, 0.5]).reshape(2, 1, 1, order="F"),
    ...
    (
        ...
        System(
            ...
            standard_system.state,
            full,
            cut=DirectedBipartition(Direction.EFFECT, (0, 2), (1,)),
        ),
        [0],
        [2],
        np.array([0.5, 0.5]).reshape(1, 1, 2, order="F"),
