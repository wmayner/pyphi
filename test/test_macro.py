...
def test_list_all_partitions():
    ...
    assert macro.list_all_partitions(net) == [[[0, 1, 2], [3]],
                                              [[0, 1, 3], [2]],
                                              [[0, 1], [2, 3]],
                                              [[0, 1], [2], [3]],
                                              [[0, 2, 3], [1]],
...
def test_list_all_groupings():
    assert macro.list_all_groupings([]) == [[]]
    partition = [[0, 1], [2, 3]]
    assert macro.list_all_groupings(partition) == [[[[0, 1], [2]], [[0, 1], [2]]],
                                                   [[[0, 1], [2]], [[0, 2], [1]]],
                                                   [[[0, 1], [2]], [[0], [1, 2]]],
                                                   [[[0, 2], [1]], [[0, 1], [2]]],
                                                   [[[0, 2], [1]], [[0, 2], [1]]],
...
def test_make_mapping():
    ...
    assert np.array_equal(mapping, np.array([0., 0., 0., 1., 0., 0., 0., 1.,
                                             0., 0., 0., 1., 2., 2., 2., 3.]))
    partition = [[0, 1], [2]]
    grouping = [[[0, 2], [1]], [[0], [1]]]
    mapping = macro.make_mapping(partition, grouping)
...
def test_make_macro_tpm():
    answer_tpm = np.array([[.375, .125, .375, .125],
                           [.375, .125, .375, .125],
                           [.375, .125, .375, .125],
                           [.375, .125, .375, .125]])
