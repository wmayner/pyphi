...
| 4 | Substrate parameter landscapes | `docs/superpowers/specs/2026-07-07-substrate-parameter-landscapes.md` (main tree; experiments in `substrate_landscape_experiments/`) |
