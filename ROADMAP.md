...
| P6a no-GIL CI | 🟡 open | 4 | no-GIL CI lane (relations now included — P6b removed the graphillion C extension that was the gap) + `lru_cache` counter-race cleanup |
