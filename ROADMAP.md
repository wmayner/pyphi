...
- **Non-docstring narrative content, current for 2.0 and 4.0.** ✅ The IIT 4.0
  **theory narrative landed**: an eight-page section under `docs/theory/`
  ...
  `docs/superpowers/plans/2026-07-08-theory-narrative.md`. Remaining narrative:
  the task-focused usage walkthroughs (the tutorials/how-tos sub-project).
