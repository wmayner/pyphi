...
| N1 paper-reproduction suite | 🟡 partial | 1 | Acceptance suite scaffolded (`test/test_paper_reproduction.py`); **IIT 4.0 (2023) Figs 1/2/4 + 6C landed** (Fig 1A logistic substrate: φ_s of a/aB/aBC + φ_c/φ_e of aB, φ_d of the 3 distinctions, φ_r({a,aB}); Fig 6C copy-ring: φ_s=1.7467 and Φ=7.65 via analytical relations). Remaining: Fig 6 A/B/D/E + Fig 7 (weights graphical-only, need authors' defs), IIT 3.0 Fig 1, AC 2019 Fig 11, Gómez p53 |
