...
| N4 disk-backed result cache | ⬜ open | 6 | Disk-persistent result cache keyed on the P9.5 `_fingerprint` (now also thread-safe + serializable); notebook re-runs and paper reproductions skip recomputation. Pulled into 2.0 (no blocker, the natural payoff of P9.5/P6a). |
