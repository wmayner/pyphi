...
| N1 paper-reproduction suite | 🟡 partial | 1 | Acceptance suite scaffolded (`test/test_paper_reproduction.py`); **IIT 4.0 (2023) Figs 1/2/4 landed** (logistic substrate reconstructed from Fig 1A; φ_s of a/aB/aBC + φ_c/φ_e of aB, φ_d of the 3 distinctions, and φ_r({a,aB}) all match the paper). Remaining: Fig 6/7, IIT 3.0 Fig 1, AC 2019 Fig 11, Gómez p53 |
